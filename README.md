...
### 1️⃣1️⃣ Ball Possession Statistics

Ball possession is calculated using frame counts.
...
```
team1% = frames_team1 / total_frames
team2% = frames_team2 / total_frames
```
...
### 1️⃣2️⃣ Final Visualization

The final annotated video includes:

* Circles under players
* Triangle marker for the ball
* Player ID
* Player speed
* Distance covered
* Team color
